...
Display names do not rename roles, secret-file scopes or stable storage identities. Independent Branch mappings/multiple Stable Targets and removal of inherited Services remain deferred. The Working copy role key is `working`, not `local`.
