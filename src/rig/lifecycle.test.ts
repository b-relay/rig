...
import { RigLifecycle, RigLifecycleLive } from "./lifecycle.js"
...
class CaptureRigLogger implements RigLoggerService {
...
const runWithLifecycle = async <A>(
  effect: Effect.Effect<A, unknown, RigLifecycle>,
  setup?: (rigd: CaptureRigd) => void,
) => {
...
describe("GIVEN rig lifecycle live service WHEN runtime-facing actions run THEN rigd is the source of truth", () => {
